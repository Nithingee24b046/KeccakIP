...
parameter d_SIZE = 512;    // output digest size (SHA3-512 → 512 bits)
parameter c_SIZE = 1024;   // capacity = 2 × d_SIZE = 2 × 512 = 1024 bits
parameter r_SIZE = 576;    // rate = 1600 - c_SIZE = 1600 - 1024 = 576 bits
parameter M_SIZE = 256;    // input message size
parameter j = 318;         // padding zeros = r_SIZE - (M_SIZE + 2)
                           //              = 576 - (256 + 2)
                           //              = 576 - 258
                           //              = 318
