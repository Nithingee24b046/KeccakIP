...
parameter d_SIZE = 256;    // output digest size (SHA3-256 → 256 bits)
parameter c_SIZE = 512;    // capacity = 2 × d_SIZE = 2 × 256 = 512 bits
parameter r_SIZE = 1088;   // rate = 1600 - c_SIZE = 1600 - 512 = 1088 bits
parameter M_SIZE = 256;    // input message size
parameter j = 830;         // padding zeros = r_SIZE - (M_SIZE + 2)
                           //              = 1088 - (256 + 2)
                           //              = 1088 - 258
                           //              = 830
