module SHA3_224(input [0:255] M, 
                input start, clk, rst,
                input [4:0] nr, 
                output reg [0: 223] Z);

parameter d_SIZE = 224;    //output digest size
parameter c_SIZE = 448;    //capacity = 2 × d_SIZE = 2 × 224 = 448 bits
parameter r_SIZE = 1152;   //rate = 1600 - c_SIZE = 1600 - 448 = 1152 bits
parameter M_SIZE = 256;    //input message size
parameter j = 894;         //padding zeros = r_SIZE - (M_SIZE + 2)
                           //              = 1152 - (256 + 2)
                           //              = 1152 - 258
                           //              = 894
